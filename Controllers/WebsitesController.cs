...
namespace WebPulse2023.Controllers
{
    public class WebsitesController : Controller
    {
        ...
        {
              return _context.Website != null ? 
                          View(await _context.Website.ToListAsync()) :
                          Problem("Entity set 'ApplicationDbContext.Website'  is null.");
        }
        ...
        [ValidateAntiForgeryToken]
        [Authorize]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Url,Name,Active")] Website website)
        {
            if (id != website.Id)
            {
                return NotFound();
